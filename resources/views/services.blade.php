...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F221506243397556" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F221506243397556" title="oEmbed Form">
<meta property="og:title" content="Car Service Booking Form" >
<meta property="og:url" content="https://form.jotform.com/221506243397556" >
  ...
  <div role="main" class="form-all">
    ...
    <ul class="form-section page-section">
        ...
        <div class="form-header-group  header-large">
          <div class="header-text httac htvam">
            <h1 id="header_1" class="form-header" data-component="header">
              Scooter Service Booking Form
            </h1>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_appointment" id="id_7">
        <label class="form-label form-label-top" id="label_7" for="input_7"> Select an Appointment Date </label>
        <div id="cid_7" class="form-input-wide" data-layout="full">
          <div id="input_7" class="appointmentFieldWrapper jfQuestion-fields">
            <input class="appointmentFieldInput " name="q7_selectAn[date]" id="input_7_date" />
            <input class="appointmentFieldInput" name="q7_selectAn[duration]" value="60" id="input_7_duration" />
      ...
      <li class="form-line" data-type="control_radio" id="id_8">
        <label class="form-label form-label-top form-label-auto" id="label_8" for="input_8"> Scooter Type </label>
      ...
      <li class="form-line" data-type="control_checkbox" id="id_12">
        <label class="form-label form-label-top form-label-auto" id="label_12" for="input_12"> Type of Services </label>
        <div id="cid_12" class="form-input-wide" data-layout="full">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_12" data-component="checkbox">
            <span class="form-checkbox-item">
              ...
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_0" name="q12_typeOf[]" value="Check the engine oil" />
              <label id="label_input_12_0" for="input_12_0"> Check the engine oil </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_1" name="q12_typeOf[]" value="Change the engine oil" />
              <label id="label_input_12_1" for="input_12_1"> Change the engine oil </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_2" name="q12_typeOf[]" value="Oil fiter replacement" />
              <label id="label_input_12_2" for="input_12_2"> Oil fiter replacement </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_3" name="q12_typeOf[]" value="Air filter replacement" />
              <label id="label_input_12_3" for="input_12_3"> Air filter replacement </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_4" name="q12_typeOf[]" value="Fuel filter replacement" />
              <label id="label_input_12_4" for="input_12_4"> Fuel filter replacement </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_5" name="q12_typeOf[]" value="Replace the aircon filter" />
              <label id="label_input_12_5" for="input_12_5"> Replace the aircon filter </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_6" name="q12_typeOf[]" value="Replace the spark plugs" />
              <label id="label_input_12_6" for="input_12_6"> Replace the spark plugs </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_7" name="q12_typeOf[]" value="Check brake fluid level" />
              <label id="label_input_12_7" for="input_12_7"> Check brake fluid level </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_8" name="q12_typeOf[]" value="Refill brake fluid" />
              <label id="label_input_12_8" for="input_12_8"> Refill brake fluid </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_9" name="q12_typeOf[]" value="Check clutch fluid" />
              <label id="label_input_12_9" for="input_12_9"> Check clutch fluid </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_10" name="q12_typeOf[]" value="Refill clutch fluid" />
              <label id="label_input_12_10" for="input_12_10"> Refill clutch fluid </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_11" name="q12_typeOf[]" value="Check Brake pads/Liners" />
              <label id="label_input_12_11" for="input_12_11"> Check Brake pads/Liners </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_12" name="q12_typeOf[]" value="Check Brake discs/Drums" />
              <label id="label_input_12_12" for="input_12_12"> Check Brake discs/Drums </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_13" name="q12_typeOf[]" value="Verify Coolant Hoses" />
              <label id="label_input_12_13" for="input_12_13"> Verify Coolant Hoses </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_14" name="q12_typeOf[]" value="Verify the charging systems" />
              <label id="label_input_12_14" for="input_12_14"> Verify the charging systems </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_15" name="q12_typeOf[]" value="Check the battery" />
              <label id="label_input_12_15" for="input_12_15"> Check the battery </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_16" name="q12_typeOf[]" value="Check power steering fluid" />
              <label id="label_input_12_16" for="input_12_16"> Check power steering fluid </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_17" name="q12_typeOf[]" value="Verify A/M Transmission Fluid" />
              <label id="label_input_12_17" for="input_12_17"> Verify A/M Transmission Fluid </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_18" name="q12_typeOf[]" value="Refill A/M Transmission Fluid" />
              <label id="label_input_12_18" for="input_12_18"> Refill A/M Transmission Fluid </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_19" name="q12_typeOf[]" value="Grease and lubricate components" />
              <label id="label_input_12_19" for="input_12_19"> Grease and lubricate components </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_20" name="q12_typeOf[]" value="Inspect timing belt or timing chain" />
              <label id="label_input_12_20" for="input_12_20"> Inspect timing belt or timing chain </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_21" name="q12_typeOf[]" value="Replace timing belt or timing chain" />
              <label id="label_input_12_21" for="input_12_21"> Replace timing belt or timing chain </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_22" name="q12_typeOf[]" value="Check tire conditions" />
              <label id="label_input_12_22" for="input_12_22"> Check tire conditions </label>
            </span>
            <span class="form-checkbox-item">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox" id="input_12_23" name="q12_typeOf[]" value="Check lights, wipers, and others" />
              <label id="label_input_12_23" for="input_12_23"> Check lights, wipers, and others </label>
            </span>
          </div>
        </div>
      </li>
...
<script type="text/javascript">JotForm.ownerView=true;</script><script src="https://cdn.jotfor.ms//js/vendor/smoothscroll.min.js?v=3.3.33697"></script>
<script src="https://cdn.jotfor.ms//js/errorNavigation.js?v=3.3.33697"></script>
