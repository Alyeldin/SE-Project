...
/* End Footer */
   ...
   <!-- Start Contact -->
   <nav>
            <div class="logo"><a href="index.html">Scooter<span>Garage</span></a></div>
            <i class="fas fa-ellipsis-v" id="menuButton"></i>
            <ul id="menu">
                <li> <a href="index.html"><class="activ">Home</li>
                <li>About</li>
        ...
        <!-- End Contact --><?php /**PATH E:\Programs Downloaded\Xampp\htdocs\SGSS\resources\views/contactus.blade.php ENDPATH**/ ?>